        ...
        <div className="border-b border-[#00AD4C]/15 bg-white">
          <div className="relative mx-auto flex h-16 max-w-[1200px] items-center px-6">
            ...
            <nav ref={navRef} aria-label="Navigation principale"
              ...
              <Link href={`/${locale}`}
                className="group relative px-3 py-2 text-[8px] font-normal text-[#1a2a1a] transition-colors hover:text-[#00AD4C]">
                Accueil
                ...
                return (
                  <div key={key} className="relative">
                    <button onClick={() => setOpenDrop(isOpen ? null : key)}
                      ...
                      className={`group relative flex items-center gap-1 px-3 py-2 text-[8px] font-normal transition-colors ${isOpen ? "text-[#00AD4C]" : "text-[#1a2a1a] hover:text-[#00AD4C]"}`}>
                      {label}
