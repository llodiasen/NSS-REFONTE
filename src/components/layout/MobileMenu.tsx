    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 150 }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 20px", borderBottom: "1px solid rgba(0,0,0,0.07)", background: "#0f2b1a" }}>
          <span style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "15px", color: "#fff" }}>
            ...
            <div style={{ borderTop: "1px solid rgba(0,0,0,0.07)", marginTop: "12px", paddingTop: "12px" }}>
              {topLinks.map((l) => (
                <Link
                  key={l.href}
                  href={l.href}
                  style={{ display: "block", padding: "12px 14px", borderRadius: "10px", textDecoration: "none", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "15px", fontWeight: 500, color: "#1a1a1a" }}
                >
                  {l.label}
                </Link>
              ))}
        ...
        <div style={{ padding: "16px 20px", borderTop: "1px solid rgba(0,0,0,0.07)", display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          <Link href={`/${locale}/membre/dashboard`} style={{ display: "block", textAlign: "center", padding: "11px", borderRadius: "8px", border: "1.5px solid #1d7a52", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "13px", fontWeight: 600, color: "#1d7a52", textDecoration: "none" }}>
            Espace Membre
          </Link>
          <Link href={`/${locale}/agir/donner`} style={{ display: "block", textAlign: "center", padding: "11px", borderRadius: "8px", background: "#c0392b", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "13px", fontWeight: 600, color: "#fff", textDecoration: "none" }}>
            Faire un don
          </Link>
        </div>
      </nav>
