  ...
  return (
    <>
        ...
        <div style={{ background: "#fff", borderBottom: "0.5px solid #dde8de" }}>
          <div style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "0 var(--container-pad)", display: "flex", alignItems: "center", height: "64px", gap: "16px" }}>
            ...
            <button onClick={() => setSlideOpen((v) => !v)}
              ...
              style={{ width: "40px", height: "40px", borderRadius: "8px", flexShrink: 0, border: `1.5px solid ${slideOpen ? "#0f2b1a" : "#1a6b3c"}`, background: slideOpen ? "#0f2b1a" : "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "5px", cursor: "pointer", transition: "all 0.25s" }}>
      ...
      <style>{`
        ...
        @media (max-width:768px) { .hdr-logo-text,.hdr-nav,.hdr-actions { display:none !important; } }
        @media (max-width:640px) { .hdr-sm-hide { display:none !important; } }
      `}</style>
    </>
  );
}
