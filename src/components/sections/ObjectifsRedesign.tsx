    ...
    <section className="obj-section" aria-labelledby="obj-titre">
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          .obj-header { padding: 80px 32px 52px; }
        ...
        @media (max-width: 768px) {
          .obj-header { padding: 72px 24px 48px; }
          .obj-h2 { font-size: clamp(38px, 9vw, 56px); }
          .obj-grid {
        ...
        @media (max-width: 480px) {
          .obj-header { padding: 60px 16px 40px; }
          .obj-h2 { font-size: clamp(34px, 10vw, 48px); }
