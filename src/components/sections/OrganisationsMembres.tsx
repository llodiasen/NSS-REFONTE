  ...
  return (
    <div className="org-card" style={{ background: "#fff", borderRadius: "10px", border: "1px solid #e8e2d9", padding: "28px 20px 24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", cursor: "default", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ width: "80px", height: "80px", borderRadius: "50%", overflow: "hidden", border: "1.5px solid #e8e2d9", display: "flex", alignItems: "center", justifyContent: "center", background: imgErr ? "linear-gradient(135deg,#1a3520,#3b7a45)" : "#f9f7f4", flexShrink: 0 }}>
        {imgErr ? (
          <span style={{ fontFamily: "var(--font-display)", fontSize: "18px", fontWeight: 600, color: "#fff" }}>{initials}</span>
        ) : (
      ...
      {/* Badge */}
      <span style={{ fontFamily: "var(--font-body)", fontSize: "10px", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", padding: "3px 10px", borderRadius: "20px", background: isFondatrice ? "#e8f2df" : "#f0ede7", color: isFondatrice ? "#3b6d11" : "#6b6358" }}>
        {org.type}
      </span>

      {/* Nom */}
      <p style={{ fontFamily: "var(--font-body)", fontSize: "13px", fontWeight: 600, color: "#1a3520", textAlign: "center", lineHeight: 1.4, margin: 0 }}>
        {org.sigle}
      </p>
      <p style={{ fontFamily: "var(--font-body)", fontSize: "11px", color: "#888", textAlign: "center", lineHeight: 1.45, margin: 0 }}>
        {org.nom}
      </p>

      {/* Pays */}
      <span style={{ fontFamily: "var(--font-body)", fontSize: "10px", fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "#aaa" }}>
        {org.pays}
      </span>
    </div>
  );
      ...
      <div style={{ maxWidth: "var(--container-max)", margin: "0 auto", padding: "0 var(--container-pad)" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "16px", marginBottom: "20px" }}>
            ...
            <span style={{ fontFamily: "var(--font-body)", fontSize: "10px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#7a7060" }}>
              Le Réseau
            </span>
            <span style={{ display: "block", flex: 1, maxWidth: "80px", height: "1px", background: "#c4bfb5" }} />
          </div>
          ...
          {/* Sous-titre */}
          <p style={{ fontFamily: "var(--font-body)", fontSize: "14px", color: "#9c9488", margin: 0, letterSpacing: "0.02em" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", maxWidth: "520px", width: "100%", background: "#fff", border: "1px solid #d4ccbd", borderRadius: "6px", overflow: "hidden" }}>
            {[
              ...
              <div key={lab} style={{ padding: "20px 16px", textAlign: "center", borderLeft: i > 0 ? "1px solid #e8e2d9" : "none" }}>
                <div style={{ fontFamily: "var(--font-display)", fontSize: "28px", fontWeight: 400, color: "#1a3520", lineHeight: 1, marginBottom: "6px" }}>{val}</div>
                <div style={{ fontFamily: "var(--font-body)", fontSize: "9px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#b0a898" }}>{lab}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ textAlign: "center", marginTop: "48px" }}>
          <button style={{ fontFamily: "var(--font-body)", fontSize: "13px", fontWeight: 500, letterSpacing: "0.05em", textTransform: "uppercase", padding: "13px 32px", background: "transparent", border: "1.5px solid #1a3520", color: "#1a3520", borderRadius: "2px", cursor: "pointer", transition: "background 0.2s, color 0.2s" }}
