  ...
  return (
    <>
      ...
      <div style={{ marginTop: "48px", marginBottom: "24px" }}>
        ...
        <h2 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(20px,2.5vw,26px)", fontWeight: 400, color: "#071A10", margin: "0 0 6px" }}>
          {title}
        </h2>
        <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "13px", color: "#9ca3af", margin: 0 }}>
