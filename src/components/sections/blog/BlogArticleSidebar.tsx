    ...
    <aside style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
      ...
      <div style={{ border: "1px solid rgba(0,0,0,0.07)", borderRadius: "16px", padding: "28px" }}>
        <div style={{ display: "flex", alignItems: "center", marginBottom: "20px" }}>
          ...
          <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "10px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "2px", color: "var(--green-600)" }}>
            Catégories
          </span>
        </div>
            ...
            {related.map((a) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <span style={{ display: "inline-block", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "10px", fontWeight: 600, letterSpacing: "1px", textTransform: "uppercase", background: b.bg, color: b.color, borderRadius: "12px", padding: "2px 8px", marginBottom: "8px" }}>
                      {a.category}
                    </span>
                    <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "15px", fontWeight: 500, color: "var(--text-primary)", lineHeight: 1.45, textAlign: "justify" }}>
                      {a.title}
                    </p>
                  </div>
                </Link>
