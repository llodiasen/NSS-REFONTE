        ...
        {state !== "playing" && (
          <>
            ...
            {video.duree && state === "idle" && (
              <span style={{ position: "absolute", bottom: "8px", right: "8px", background: "rgba(0,0,0,0.65)", color: "#ffffff", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "11px", fontWeight: 500, padding: "2px 7px", borderRadius: "4px", zIndex: 2, letterSpacing: "0.02em" }}>
                {video.duree}
              </span>
            )}
          </>
