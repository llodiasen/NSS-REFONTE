  ...
  return (
    ...
    >
      ...
      <div style={{ height: "180px", background: imgBg, position: "relative", flexShrink: 0, overflow: "hidden" }}>
        ...
        />
        {/* Badge type */}
        <span style={{ position: "absolute", top: "12px", left: "12px", background: typeSt.bg, color: typeSt.color, fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "10px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", padding: "3px 10px", borderRadius: "20px" }}>
          {ev.type}
        </span>
        {/* Badge statut */}
        <span style={{ position: "absolute", top: "12px", right: "12px", background: avenir ? "#D6F5EB" : "#EEEDE9", color: avenir ? "#0E6E4A" : "#888780", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "10px", fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", padding: "3px 10px", borderRadius: "20px" }}>
      ...
      <div style={{ padding: "20px", display: "flex", flexDirection: "column", flex: 1, gap: "10px" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
          <span style={{ display: "flex", alignItems: "center", gap: "5px", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "12px", fontWeight: 500, color: dateColor }}>
            <IconCalendar color={dateColor} />{ev.date}
          </span>
          <span style={{ display: "flex", alignItems: "center", gap: "5px", fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "12px", color: "#4a4a45" }}>
            <IconPin color="#4a4a45" />{ev.lieu}
          </span>
        </div>

        {/* Titre */}
        <h3 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "18px", fontWeight: 400, lineHeight: 1.3, color: "var(--text-primary)", margin: 0 }}>
          {ev.titre}
        </h3>

        {/* Description */}
        <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "15px", lineHeight: 1.6, color: "var(--text-primary)", margin: 0, textAlign: "justify" }}>
          {ev.description}
        </p>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
          {ev.tags.map((tag) => (
            <span key={tag} style={{ background: tagBg, color: tagColor, fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "11px", fontWeight: 500, padding: "3px 10px", borderRadius: "20px" }}>
              {tag}
            </span>
          ))}
        </div>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "48px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "14px", marginBottom: "18px" }}>
            ...
            <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "9px", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#1D9E75" }}>
              Nos événements
            </span>
            <div style={{ width: "40px", height: "1px", background: "#1D9E75" }} />
          </div>
          <h2 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(21px, 3vw, 30px)", fontWeight: 400, fontStyle: "normal", color: "var(--text-primary)", lineHeight: 1.18, margin: "0 0 16px" }}>
            Se rencontrer, se former, agir ensemble.
          </h2>
          <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "clamp(14px, 1.5vw, 17px)", lineHeight: 1.65, color: "var(--text-primary)", maxWidth: "580px", margin: "0 auto" }}>
