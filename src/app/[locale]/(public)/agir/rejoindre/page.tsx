    ...
    <>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
            ...
            <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "12px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.12em", color: "#97C459", whiteSpace: "nowrap" }}>
              Rejoindre NSS
            </span>
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", background: "#2d6a4f" }}>
        {STATS.map(({ value, label }, i) => (
          <div key={label} style={{ padding: "28px 32px", textAlign: "center", borderRight: i < STATS.length - 1 ? "1px solid rgba(255,255,255,0.12)" : "none" }}>
            <div style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "38px", fontWeight: 400, color: "#ffffff", lineHeight: 1, marginBottom: "6px" }}>{value}</div>
            <div style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "10px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "2px", color: "rgba(255,255,255,0.5)" }}>{label}</div>
          </div>
        ))}
      </div>
        ...
        <div style={{ maxWidth: "var(--container-max)", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "52px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", marginBottom: "16px" }}>
              ...
              <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "11px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "2.5px", color: "var(--green-600)" }}>Pourquoi adhérer</span>
              <span style={{ width: "28px", height: "1px", background: "rgba(29,106,63,0.35)", display: "block" }} />
            </div>
            <h2 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(26px,3vw,38px)", fontWeight: 400, color: "#071A10", margin: 0 }}>
              Rejoindre NSS, c&apos;est{" "}
          ...
          <div className="adhesion-cards" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "24px" }}>
            {BENEFICES.map(({ icon, titre, texte }) => (
              <div key={titre} style={{ background: "#ffffff", borderRadius: "12px", padding: "32px 28px", border: "1.5px solid rgba(0,0,0,0.07)" }}>
                ...
                <h3 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "20px", fontWeight: 400, color: "#071A10", marginBottom: "10px" }}>{titre}</h3>
                <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "15px", lineHeight: 1.7, color: "#4b5563", margin: 0 }}>{texte}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="formulaire" style={{ background: "#ffffff", padding: "80px var(--container-pad)" }}>
        <div style={{ maxWidth: "var(--container-max)", margin: "0 auto" }}>
          <div className="adhesion-form-grid" style={{ display: "grid", gridTemplateColumns: "2fr 3fr", gap: "64px", alignItems: "start" }}>
            ...
            <div>
              <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "11px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "2.5px", color: "var(--green-600)", display: "block", marginBottom: "16px" }}>
                S&apos;engager concrètement
              </span>
              <h2 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(22px,2.5vw,30px)", fontWeight: 400, color: "#071A10", marginBottom: "28px", lineHeight: 1.2 }}>
                Adhérer,{" "}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {ENGAGEMENTS.map(({ titre, texte }) => (
                  <div key={titre} style={{ display: "flex", gap: "14px", alignItems: "flex-start" }}>
                    ...
                    <div>
                      <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "14px", fontWeight: 700, color: "#071A10", marginBottom: "4px" }}>{titre}</p>
                      <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "13px", lineHeight: 1.65, color: "#6b7280", margin: 0 }}>{texte}</p>
                    </div>
                  </div>
                ))}
              </div>
                  ...
                  <div key={step} style={{ display: "flex", alignItems: "center", flex: 1 }}>
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
                      <div style={{
                        ...
                        fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "12px", fontWeight: 600,
                      }}>
                        {i + 1}
                      </div>
                      <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "10px", color: i === 0 ? "var(--green-600)" : "#9ca3af", whiteSpace: "nowrap" }}>{step}</span>
                    </div>
                    {i < STEPS.length - 1 && (
      ...
      <section style={{ background: "#eaf3de", padding: "72px var(--container-pad)" }}>
        <div style={{ maxWidth: "var(--container-max)", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", marginBottom: "16px" }}>
              <span style={{ width: "28px", height: "1px", background: "rgba(29,106,63,0.35)", display: "block" }} />
              <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "11px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "2.5px", color: "var(--green-600)" }}>FAQ</span>
              <span style={{ width: "28px", height: "1px", background: "rgba(29,106,63,0.35)", display: "block" }} />
            </div>
            <h2 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(24px,3vw,34px)", fontWeight: 400, color: "#071A10", margin: 0 }}>
          ...
          <div className="faq-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "20px" }}>
            {FAQ.map(({ q, r }) => (
              <div key={q} style={{ background: "#ffffff", borderRadius: "12px", padding: "28px 24px", border: "1.5px solid rgba(0,0,0,0.07)" }}>
                <h3 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "17px", fontWeight: 400, color: "#071A10", marginBottom: "12px", lineHeight: 1.3 }}>{q}</h3>
                <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "14px", lineHeight: 1.7, color: "#4b5563", margin: 0 }}>{r}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: "#1a3d2b", padding: "72px var(--container-pad)", textAlign: "center" }}>
        <div style={{ maxWidth: "640px", margin: "0 auto" }}>
          <span style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "11px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "2.5px", color: "var(--green-300)", display: "block", marginBottom: "16px" }}>
            Ensemble
          </span>
          <h2 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(26px,3vw,38px)", fontWeight: 400, color: "#ffffff", marginBottom: "16px", lineHeight: 1.18 }}>
            Par nous-mêmes. Pour nous-mêmes.{" "}
            <em style={{ fontStyle: "italic", color: "var(--green-300)" }}>En nous-mêmes.</em>
          </h2>
          <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "16px", lineHeight: 1.7, color: "rgba(255,255,255,0.75)", marginBottom: "36px" }}>
