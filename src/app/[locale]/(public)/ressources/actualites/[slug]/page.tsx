    ...
    if (block.startsWith("> ")) {
      nodes.push(
        <blockquote key={i} style={{ borderLeft: "2px solid #1D9E75", padding: "4px 0 4px 24px", margin: "36px 0" }}>
          <p style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "17px", fontWeight: 400, fontStyle: "italic", color: "#2d5a3d", lineHeight: 1.6, margin: 0, textAlign: "justify" }}>
      ...
      <section style={{ background: "var(--green-900)", position: "relative", overflow: "hidden", minHeight: "360px" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: "var(--container-max)", margin: "0 auto", padding: "48px var(--container-pad) 32px" }}>
          <div style={{ maxWidth: "820px" }}>
            <p style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontSize: "14px", color: "rgba(255,255,255,0.4)", marginBottom: "28px" }}>
            ...
            <h1 style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif", fontSize: "clamp(22px, 2.8vw, 32px)", fontWeight: 400, lineHeight: 1.15, color: "#ffffff", marginBottom: "0" }}>
              {article.title}
            </h1>
